...
def decode_offset(offset):
	...
	try:
		offset = binascii.unhexlify(offset)#Return the binary data represented by the hexadecimal string hexstr
		#e.g 0x37654136-->chr(0x37)==7 chr(0x65)==e chr(0x41)==A chr(0x36)=6,so result is '7eA6'
		offset = offset[::-1]#reverse '7eA6' -->'6Ae7'
